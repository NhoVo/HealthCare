  ...
  return (
    <div>
      ...
      <div className={cx("validate")}>
        {checked.length > 0 ? (
          <div className={cx("numberCheck")}>
            Số người đã chọn:({checked.length})
          </div>
        ) : null}
          ...
          <div className={cx("conversations")}>
            <div className={cx("list-conversation")}>
              <div className={cx("input-radio")}>
                {addMemerber ? (
                  <input
                    ...
                    // checked={
                    //   conversation.members.includes(searchResult._id)
                    //     ? true
                    //     : null
                    // }
                  />
              ...
              <img
                ...
                src={searchResult?.avatar ? searchResult.avatar : images.logo}
                alt="avatar"
              />
