...
function Messenger({ conversationPhoneBook }) {
  ...
  const handleBlockedSingle = () => {
    ...
    //   `Bạn có chắc chắn muốn chặn tin nhắn của ${conversation.name} không?`
    // );
    // if (choice === true) {
    //   const data = {
    //     conversationId: conversation.id,
  ...
  const handleUnBlockedSingle = () => {
    // let choice = window.confirm(
    //   `Bạn có chắc chắn muốn bỏ chặn tin nhắn của ${conversation.name} không?`
    // );
    // if (choice === true) {
    //   const data = {
    //     conversationId: conversation.id,
      ...
      {false ? (
        <>
          {false ? (
            ...
            <div className={cx("Block")}>
              <h2>Bạn đã bị chặn nhắn tin bởi ...</h2>
            </div>
          )}
        </>
      ) : (
