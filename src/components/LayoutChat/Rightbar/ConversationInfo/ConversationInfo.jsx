...
function ConversationInfo({ conversationPhoneBook }) {
  //xem lại chỗ này
  const conversation = conversationPhoneBook ? conversationPhoneBook : null;
        ...
        <>
          <div className={cx("container")}>
            ...
            <div className={cx("info")}>
              ...
              {avatarGroup && (
                <button
                  className={cx("btn-update-avatar-group")}
                  onClick={handleUpdateAvatarGroup}
                >
                  Cập nhật
                </button>
              )}
              ...
              <div className={cx("info-avatar")}>
                ...
                {false ? (
                  ...
                  <div className={cx("avatar")}>
                    <ModelInfoAccount ConversationInfo user={""} />
                  </div>
                )}
              </div>
              ...
              >
                <div className={cx("model-change-name-bg")}>
                  ...
                  <div className={cx("model-change-name-content")}>
                    ...
                    <p>
                      Bạn có muốn đổi tên nhóm, khi xác nhận tên nhóm mới sẽ
