...
function UserInGroup({ user, conversationInfo }) {
  ...
  const handleCallback = () => {
    ...
    //   friend.receiverId.includes(user._id)
    // );
    // const data = {
    //   status: true,
  ...
  const handleChangeLeader = () => {
    // let checkOutGroup = window.confirm(
    //   "Bạn có chắc chắn muốn chuyển quyền trưởng nhóm không?"
    // );
    // if (checkOutGroup === true) {
    //   const data = {
    //     conversationId: conversationClicked.id,
  ...
  const handleCancelBlockMember = () => {
    // let checkOutGroup = window.confirm(
    //   "Bạn có chắc chắn muốn bỏ chặn tin nhắn không?"
    // );
    // if (checkOutGroup === true) {
    //   const data = {
    //     conversationId: conversationClicked.id,
  ...
  const handleBlockMember = () => {
    // let checkOutGroup = window.confirm(
    //   "Bạn có chắc chắn muốn chặn tin nhắn không?"
    // );
    // if (checkOutGroup === true) {
    //   const data = {
    //     conversationId: conversationClicked.id,
                  ...
                  render={(attrs) => (
                    <div tabIndex="-1" {...attrs}>
                      <Popper className={cx("own-menu-list-children")}>
                        ...
                        <p
                          className={cx("deleteFriend")}
                          onClick={handleDeleteMemberGroup}
                        >
                          <button className={cx("item-btn")}>
                            Xóa khỏi nhóm
                          </button>
                        ...
                        {conversationClicked.blockBy.includes(user?._id) ? (
                          <p
                            className={cx("deleteFriend")}
                            onClick={handleCancelBlockMember}
                          >
